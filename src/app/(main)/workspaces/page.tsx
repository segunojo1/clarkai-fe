          ...
          <div className="w-64 p-6">
            <div className="dark:bg-[#2a2a2a] bg-[#F0F0EF] rounded-lg p-6  relative">
              ...
              <div className="text-center">
                <p className="dark:text-gray-300 text-[#A3A3A3] text-sm">
          ...
          <div className="flex-1 flex flex-col items-start justify-center text-center px-8 pl-16">
            <div className="max-w-[600px]">
              ...
              <p className="text-gray-400 text-base leading-relaxed mb-8 max-w-lg">
                ...
                from subjects to side projects—into custom spaces built for deep
                  ...
                  <Link href={`/workspaces/${workspace.enc_id}`} className="">
                    <div className="dark:hover:bg-[#2C2C2C] flex flex-col items-center hover:bg-[#F0F0EF] rounded-[14.6px] p-6 ">
                      <div className="flex justify-center  max-w-[160px]  mb-[19.44px] relative">
                        ...
                        />
                        <Globe
                          className="absolute left-[9.7px] bottom-[9.9px] w-[19px] h-[19px]"
