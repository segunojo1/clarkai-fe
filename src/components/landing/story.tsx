  ...
  const contentBlocks = [
    {
      ...
      image1: { src: "/assets/landing/file.svg", position: "top-[-18px] left-[53%] w-[30px] h-[30px]" },
      highlight: "colors.",
      initialColor: "#F24E06",
    },
    {
      text: "Not because we hate learning, but because we’ve figured out how to learn smarter.",
      image1: { src: "/assets/landing/spark.svg", position: "md:top-[35px] top-[54px] md:left-[19%] left-[20%] md:w-[39px] w-[20px] h-[20px] md:h-[25px]" },
    },
    {
      ...
      image1: { src: "/assets/landing/mdi_sleep.svg", position: "top-[75px] left-[7%] animate-pulse w-[30px] h-[30px]" },
    },
    {
      text: "That’s why we built",
      image1: { src: "/assets/landing/clark_icon.svg", position: "md:top-[-35px] top-[-15px] md:w-[90px] w-[60px] h-[49px] md:h-[79px] right-[-54px] md:right-[-76px]" },
    },
    {
      ...
      image1: { src: "/assets/landing/upload-01.svg", position: "top-[0px] right-0 w-[24px] h-[24px]" },
      image2: { src: "/assets/landing/pointers.svg", position: "md:top-[37px] top-[50px] right-[30%] md:w-[123px] w-[103px] md:h-[52px] h-[44px] animate-pulse" },
    },
    {
      ...
      image1: { src: "/assets/landing/clark_icon2.svg", position: "bottom-[7px] md:right-[37%] left-0 md:block hidden md:left-auto md:w-[64px] w-[44px] h-[56px]" },
    },
    {
      text: "Built by students, for students.",
      image1: { src: "/assets/landing/clark_icon3.svg", position: "md:bottom-[0px] bottom-[5px] md:right-[-90px] md:w-[100px] w-[50px] right-[-40px] block" },
