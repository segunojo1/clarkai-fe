        ...
        >
          ...
          Reinvented
            ...
            <div className='relative'>
                <Image src='/assets/landing/exploree.png' alt='explore materials' draggable={false} width={424} height={533} />
                <ul className='font-satoshi absolute bottom-12 mx-auto left-0 right-0 py-[5px] px-4 pr-2 text-[13px]/[120%] bg-black rounded-[36px] text-white flex items-center gap-4 w-fit'>
                    ...
                    <Link href='/auth/signup' className='py-2 px-4 text-[13px]/[120%] bg-[#F14E07] rounded-[23px] flex items-center gap-2'>
                        Join Clark Now
