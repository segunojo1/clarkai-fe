  ...
  return (
    <>
      <section className="max-w-[341px] flex flex-col items-center w-full">
        <h1 className="text-[#737373] text-[29px] font-semibold text-center">
          Add a profile photo
        </h1>
      ...
      {isRedirecting && (
        <div className="fixed inset-0 z-[100] bg-white/85 backdrop-blur-sm flex flex-col items-center justify-center gap-4">
          <svg
            className="h-8 w-8 animate-spin text-[#FF3D00]"
            viewBox="0 0 24 24"
            fill="none"
            aria-hidden="true"
          >
          ...
          <p className="text-sm text-[#525252]">
            Setting up your account and taking you home...
          </p>
        </div>
      )}
    </>
