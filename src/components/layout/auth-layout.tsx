...
export default function AuthClientLayout({
  ...
  return (
    <div className="flex flex-col w-full min-h-screen">
      ...
      <div
        className={`flex w-full min-h-screen p-10 px-32 pt-24 ${!showSidebar ? "justify-center" : ""}`}
      >
        {showSidebar && (
              ...
              {currentStep === "add-profile" ? (
                <>
                  <Image
                    src={
                      theme === "dark"
                        ? "/assets/add-your-look-dark.png"
                        : "/assets/add-your-look.png"
                    }
                    alt="add your look"
                    width={300}
                    height={300}
        ...
        <main
          className={`${showSidebar ? "w-1/3 ml-[33.333%]" : "w-full max-w-2xl"} flex pt-[53px] justify-center`}
        >
          {children}
        </main>
